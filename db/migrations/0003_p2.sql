...
INSERT OR IGNORE INTO kb_docs (slug, title, blocks) VALUES
  ('welcome', 'Welcome to your dashboard',
   '{"blocks":[{"type":"hero","title":"Welcome to your dashboard","subtitle":"A quick tour of what you can do here."},{"type":"paragraph","text":"This dashboard is yours. Your data lives in your own database, isolated from everyone else."},{"type":"callout","variant":"info","title":"Tip","text":"Open Settings to rename the dashboard, switch theme, and choose which pages appear."},{"type":"list","items":["Track projects and goals","Connect tools with your own key","Keep notes here in the knowledge base"]},{"type":"steps","items":[{"title":"Make it yours","text":"Set a display name and theme in Settings."},{"title":"Add real content","text":"Replace the demo projects and goals with your own."}]}]}'),
  ('customize', 'Customizing your dashboard',
   '{"blocks":[{"type":"heading","text":"Customizing your dashboard","level":2},{"type":"paragraph","text":"You control which pages show and in what order, all from the Settings page."},{"type":"steps","items":[{"title":"Open Settings"},{"title":"Toggle pages on or off"},{"title":"Reorder them with the arrows"},{"title":"Save your changes"}]},{"type":"callout","variant":"success","title":"Backup and transfer","text":"Use Export to download your config, and Import to carry your setup to a fresh fork."},{"type":"keyvalue","items":[{"key":"Home","value":"Always on"},{"key":"Theme","value":"Light, dark, or system"},{"key":"Tools","value":"Needs your pai-tools key"}]}]}'),
